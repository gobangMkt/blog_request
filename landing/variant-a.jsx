  ...
  return (
    <span style={{ position: 'relative', display: 'inline-flex', alignItems: 'center', cursor: 'help' }}
      ...
      <span style={{
        ...
        background: 'rgba(43,133,204,0.12)', color: 'var(--primary-400)',
        ...
        <div className="container center-stack" style={{ maxWidth: 820 }}>
          ...
          <div style={{ animation: 'gemFloat 3.5s ease-in-out infinite', marginBottom: 28 }}>
            <img
              ...
              alt="고방 neoflatMKT"
              style={{ height: 108, width: 'auto', filter: 'drop-shadow(0 8px 24px rgba(43,133,204,0.22))' }}
            />
          </div>

          <span className="eyebrow" style={{
            background: 'linear-gradient(90deg, #E8F2FA 0%, #EAF4FD 100%)',
            color: '#1A6BAA',
          ...
          <div style={{
            ...
            {[
              ...
              <a key={i} href={item.href} style={{
                fontSize: 16, fontWeight: 600, color: 'var(--fg-3)',
          ...
          <div style={{
            ...
            {[
              { n: '67%',   l: '할인율',   c: '#2B85CC' },
              { n: '30건',  l: '한정 수량', c: '#3D96D8' },
              { n: '31일',  l: '판매 기간', c: '#4AA8E0' },
              { n: '1주 내', l: '발행까지', c: '#2B85CC' },
            ].map((s, i) => (
        ...
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 16, marginBottom: 24 }}>
            ...
            <div style={{ background: '#fff', borderRadius: 20, padding: '36px 28px', border: '1px solid var(--border-input)' }}>
              <div style={{ fontSize: 15, fontWeight: 700, color: '#2B85CC', background: '#E8F2FA', padding: '5px 14px', borderRadius: 100, display: 'inline-block', marginBottom: 16 }}>방문자 수</div>
              <div style={{ fontSize: 44, fontWeight: 900, color: '#2B85CC', letterSpacing: '-1px', lineHeight: 1.1, marginBottom: 12 }}>17~18만</div>
            ...
            <div style={{ background: '#fff', borderRadius: 20, padding: '36px 28px', border: '1px solid var(--border-input)' }}>
              <div style={{ fontSize: 15, fontWeight: 700, color: '#3D96D8', background: '#DCF0FA', padding: '5px 14px', borderRadius: 100, display: 'inline-block', marginBottom: 16 }}>블로그 지수</div>
              <div style={{ fontSize: 44, fontWeight: 900, color: '#3D96D8', letterSpacing: '-1px', lineHeight: 1.1, marginBottom: 12, display: 'flex', alignItems: 'center' }}>
                최적화 2+
            ...
            <div style={{ background: '#fff', borderRadius: 20, padding: '36px 28px', border: '1px solid var(--border-input)' }}>
              <div style={{ fontSize: 15, fontWeight: 700, color: 'var(--primary-400)', background: 'var(--primary-100)', padding: '5px 14px', borderRadius: 100, display: 'inline-block', marginBottom: 16 }}>특화 채널</div>
              ...
              <div style={{ display: 'flex', gap: 8, marginBottom: 10 }}>
                {['고시원', '셰어하우스'].map((kw, i) => (
                  <span key={i} style={{
                    fontSize: 16, fontWeight: 700, padding: '5px 14px',
          ...
          <div style={{ background: '#fff', borderRadius: 20, padding: '44px 48px', border: '1px solid var(--border-input)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'end' }}>
              ...
              <div>
                <div style={{ display: 'flex', gap: 20, alignItems: 'flex-end', justifyContent: 'center' }}>
                  <div style={{ flex: 1, textAlign: 'center' }}>
                    <div style={{ fontSize: 20, fontWeight: 800, color: 'var(--fg-2)', marginBottom: 12, whiteSpace: 'nowrap' }}>30만 원~</div>
                    <div style={{
                  ...
                  <div style={{ flex: 1, textAlign: 'center' }}>
                    ...
                    <div style={{ fontSize: 20, fontWeight: 900, color: '#2B85CC', marginBottom: 12, whiteSpace: 'nowrap' }}>10만 원</div>
                    <div style={{
                      height: 56, width: '100%',
                      background: 'linear-gradient(180deg, #4AA8E0 0%, #2B85CC 100%)',
                      borderRadius: '10px 10px 0 0',
                      transformOrigin: 'bottom',
                      animation: 'growBar 0.9s 0.6s ease both',
                      display: 'block',
                    }} />
                    <div style={{ height: 3, background: '#2B85CC', margin: 0 }} />
                    <div style={{
                      padding: '12px 0',
                      fontSize: 16, color: '#2B85CC', fontWeight: 700,
                    }}>고방 블로그</div>
                  </div>
                </div>
              </div>
              ...
              {/* 오른쪽: 비교 테이블 */}
              <div>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr auto auto', gap: '0 20px', marginBottom: 12, paddingBottom: 10, borderBottom: '2px solid var(--border-input)' }}>
                  <div></div>
                  <div style={{ fontSize: 15, fontWeight: 700, color: 'var(--fg-3)', textAlign: 'center', minWidth: 72 }}>일반</div>
                  <div style={{ fontSize: 15, fontWeight: 800, color: '#2B85CC', textAlign: 'center', minWidth: 88 }}>고방 블로그</div>
                </div>
                {[
                  { label: '가격',       normal: '30만 원~', gobang: '10만 원' },
                  { label: '채널 트래픽', normal: '미보장',   gobang: '월 17만+' },
                  { label: '블로그 등급', normal: '일반',     gobang: '최적화 2+' },
                  { label: '키워드 선택', normal: '제한적',   gobang: '1~3개 직접' },
                  { label: '발행 기간',  normal: '2~4주+',   gobang: '1주 내' },
                  { label: '결과 알림',  normal: '없음',      gobang: '카카오 알림톡' },
                ].map((row, i, arr) => (
                  <div key={i} style={{
                    ...
                    <div style={{ fontSize: 16, color: 'var(--fg-2)', fontWeight: 600 }}>{row.label}</div>
                    <div style={{ fontSize: 15, color: 'var(--fg-4)', textAlign: 'center', minWidth: 72, textDecoration: 'line-through' }}>{row.normal}</div>
                    <div style={{ fontSize: 15, fontWeight: 800, color: '#2B85CC', textAlign: 'center', minWidth: 88 }}>{row.gobang}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div style={{
              ...
              background: 'linear-gradient(90deg, #E8F2FA 0%, #EAF4FD 100%)',
              borderRadius: 12, border: '1px solid #B2D4EF',
              fontSize: 18, color: 'var(--fg-1)', fontWeight: 600,
        ...
        <div className="container center-stack" style={{ maxWidth: 720 }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16 }}>
              ...
              <div style={{
                ...
                borderRadius: 12, border: '1px solid #B2D4EF',
                fontSize: 19, color: 'var(--fg-1)', fontWeight: 600, lineHeight: 1.6,
                textAlign: 'center', wordBreak: 'keep-all',
              }}>
                💡 일반 블로그 마케팅 대비 <strong style={{ color: '#2B85CC' }}>3분의 1 가격</strong>,
                채널 품질은 그 이상이에요.
              </div>
            </div>
          </div>
          ...
          <div style={{ width: '100%', marginTop: 56 }}>
            <div style={{ marginBottom: 32, textAlign: 'center' }}>
              ...
              <div style={{ fontSize: 18, color: 'var(--fg-3)' }}>추가 비용 없이 신청부터 발행 완료까지</div>
            </div>
            <BenefitsGrid />
          </div>
        </div>
      ...
      <section id="process" style={{ background: 'var(--bg-app)', padding: '100px 0' }}>
        <div className="container" style={{ maxWidth: 760 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {[
              { n: 1, t: '구매 / 신청',     d: '신청 폼에서 지점 정보·키워드·강조 내용 입력',    tag: '사장님', c: '#2B85CC' },
              { n: 2, t: '대상자 선정',     d: '내부 검토 후 알림톡으로 연락 (30건 한정)',       tag: '고방',   c: '#3D96D8' },
              { n: 3, t: '결제',           d: '안내받은 방법으로 결제 — 100,000원 (VAT 별도)', tag: '사장님', c: '#4AA8E0' },
              { n: 4, t: '블로그 작성 · 발행', d: '결제 후 1주 내 작성 → 공식 블로그 발행',      tag: '고방',   c: '#2B85CC' },
              { n: 5, t: '결과 안내',       d: '발행 URL을 카카오 알림톡으로 발송',             tag: '완료',   c: '#2B85CC' },
            ].map((s, i) => (
              <div key={i} style={{
      ...
      <section id="faq" style={{ padding: '100px 0' }}>
        <div className="container" style={{ maxWidth: 760 }}>
          ...
          <div style={{ background: '#fff', borderRadius: 18, padding: '8px 28px', border: '1px solid var(--border-input)' }}>
            <FaqItem defaultOpen
              q="작성 후 알림을 주나요?"
              a="네, 작성이 완료되면 <strong>신청 시 입력한 번호로 카카오톡 알림</strong>이 발송돼요. 발행된 포스팅 URL도 함께 전달되니 바로 확인하실 수 있어요." />
            <FaqItem
              q="작성한 블로그는 어디에 노출되나요?"
              a="신청하신 키워드를 기준으로 <strong>네이버 블로그탭 상위 10위 진입을 목표</strong>로 작성해요. 다만 네이버 검색 알고리즘 특성상 노출 순위 및 유지 기간은 변동될 수 있어요." />
            <FaqItem
        ...
        <div className="container">
          <div style={{
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              <div style={{ fontSize: 19, fontWeight: 800, letterSpacing: '0.5px', opacity: 0.92, marginBottom: 20 }}>
                05.01~05.31 · 30건 한정
              </div>
